...
public interface DbRatingRepository extends JpaRepository<DbRatings, Long> {
    ...
    @Query("SELECT new com.example.movie_review.user.DTO.WeeklyUserDTO(new com.example.movie_review.user.DTO.UserCommonDTO(u.id, u.email, u.nickname, u.picture), COUNT(r), true) " +
