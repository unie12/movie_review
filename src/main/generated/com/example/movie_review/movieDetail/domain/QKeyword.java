...
public class QKeyword extends EntityPathBase<Keyword> {
    ...
    private static final long serialVersionUID = 833093794L;

    public static final QKeyword keyword = new QKeyword("keyword");

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final SetPath<MovieKeyword, QMovieKeyword> movieKeywords = this.<MovieKeyword, QMovieKeyword>createSet("movieKeywords", MovieKeyword.class, QMovieKeyword.class, PathInits.DIRECT2);
